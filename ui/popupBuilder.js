...
export async function showQuickStatePopup() {
    ...
    rootHtml += `<div id="tab-config" class="st-tab-content" style="display: none; overflow-y: auto; max-height: 65vh; padding-right: 5px;">`;
    rootHtml += `
    ...
    rootHtml += `<div id="tab-prompt" class="st-tab-content" style="display: none; overflow-y: auto; max-height: 65vh; padding-right: 5px;">`;
    rootHtml += `
